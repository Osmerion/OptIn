...
import com.osmerion.optin.tools.apt.compiler.java.JavaTestCompiler;
import com.osmerion.optin.tools.apt.compiler.kotlin.KotlinTestCompiler;
...
public final class Compilers {
    ...
    public static TestCompiler kotlinc() {
        return kotlinc;
    }
