...
final class MethodTest extends AbstractFunctionalTest {

    @Test
    void testSiblingMethod_Undeclared() {
    ...
    @Test
    void testMethodInMarkedClass_Undeclared() {
        SourceFile cls = createJavaFile(
            "com.example.TestClass",
            """
            package com.example;
            
            import static com.example.producer.alpha.MarkedClass.*;
            
            public class TestClass {
            
                void foo() {
                    unmarkedMethodInMarkedClass();
                }
