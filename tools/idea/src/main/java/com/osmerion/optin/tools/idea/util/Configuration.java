 ...
 */
package com.osmerion.optin.tools.idea.util;
...
public final class Configuration {
    ...
    /**
     * {@return extra opt-in marker annotations}
     *
     * <p>This set may not contain annotation types that already are annotated with {@code RequiresOptIn}.</p>
     */
    ...
    /**
     * {@return extra subtyping opt-in marker annotations}
     *
     ...
     * @param message       the message for the requirement
     * @param level         the level for the requirement
     */
    public record ExtraRequiresOptIn(String targetFqName, String message, Level level) {}
